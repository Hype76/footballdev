...
comment on function app_private.normalize_player_parent_invite_emails() is
  'Canonicalizes Parent contact emails without requiring authenticated clients to access the private helper schema, while preserving Coach mobile contact append behaviour.';
