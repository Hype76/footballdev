-- Include the saved pitch surface in the existing parent-scoped match response.
...
comment on function public.get_parent_portal_match_day_extended_state(uuid) is 'Parent-visible match context and saved clock settings and pitch surface, scoped by the canonical current parent fixture access.';
