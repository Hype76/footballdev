alter table public.match_days
  add column if not exists motm_notify_results_on_close boolean not null default false;

comment on column public.match_days.motm_notify_results_on_close is
  'When true, the generated Player of the Match poll uses the standard automatic result notification delivery.';
