export const PARENT_PARITY_MATRIX = Object.freeze([
  ...
  { capability: 'Messages', mobileEquivalent: 'Messages', read: true, write: true, childScope: 'selected child', offline: 'cache plus queued read receipt', deepLink: 'message target', states: 'read unread empty', authority: 'Parent communication RPCs', status: 'implemented' },
