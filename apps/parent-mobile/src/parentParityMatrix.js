export const PARENT_PARITY_MATRIX = Object.freeze([
  ...
  { capability: 'Parent Game Day', mobileEquivalent: 'Matchday detail', read: true, write: true, childScope: 'accepted Parent scorer only', offline: 'encrypted match cache and ordered scorer action replay', deepLink: 'matchday target', states: 'clock score goals shootout', authority: 'idempotent server scorer command RPC', status: 'implemented' },
