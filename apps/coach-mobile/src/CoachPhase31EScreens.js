...
function phaseStyles(palette) {
  return StyleSheet.create({
    ...
    messageBubbleOwn: { alignSelf: 'flex-end', backgroundColor: palette.selected, borderColor: palette.accentText },
    ...
    carpoolOffer: { color: palette.accentText },
    availabilitySelected: { color: palette.accentText, fontSize: 11, fontWeight: '900', textTransform: 'uppercase' },
    ...
    primary: { alignItems: 'center', backgroundColor: palette.accent, borderColor: palette.accentText, borderWidth: 1, borderRadius: 12, minHeight: 48, justifyContent: 'center', paddingHorizontal: 14, paddingVertical: 10 },
...
function InvitesDomain({ data, load, onNavigate, palette, reloadHome, setNotice, stale, styles, user }) {
  ...
  const renderTrainingAvailability = (group) => {
    const trainingSummary = summarizeCoachInvites(collapseCoachInvitesByPlayer(group.invites))
  ...
  const renderMatchAvailability = (match) => {
