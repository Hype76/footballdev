  ...
  return <View style={styles.container}>
    ...
    <Modal visible={Boolean(details) || detailsId === 'legend'} transparent animationType="fade" onRequestClose={() => setDetailsId(null)}>
      <View style={styles.modalBackdrop}><View accessibilityViewIsModal style={styles.modalCard}><ScrollView>
        ...
        {detailsId === 'legend' ? <><Text style={styles.detailText}>Sent: The message was sent.</Text><Text style={styles.detailText}>Delivered: Delivery was confirmed.</Text><Text style={styles.detailText}>Seen: A parent or player has replied.</Text><Text style={styles.detailText}>An empty circle means we do not have confirmation.</Text></> : null}
