...
export function normalizeCoachInvite(row = {}, kind = 'calendar') {
  ...
  return Object.freeze({
    ...
    transportCanOfferLift: Boolean(row.transport_can_offer_lift ?? row.transportCanOfferLift),
    transportNeedsLift: Boolean(row.transport_needs_lift ?? row.transportNeedsLift),
