...
console.log('- Steve and Simon are active App Store Connect users with access to both Coach and Parents.')
console.log('- Steve and Simon belong to the Internal Testers group for both apps.')
console.log('- The latest Coach and Parents iOS builds are visible to both internal testers.')
...
console.log('iOS submit commands also require MOBILE_IOS_INTERNAL_TESTERS_CONFIRMED=true after both testers and both apps are verified.')
