export const mobileApps = [
  {
    ...
    appIcon: 'apps/coach-mobile/assets/icon.png',
    appRole: 'coach',
    adaptiveIcon: 'apps/coach-mobile/assets/adaptive-icon.png',
    ...
    splashIcon: 'apps/coach-mobile/assets/splash-icon.png',
  ...
  },
  {
    ...
    appIcon: 'apps/parent-mobile/assets/icon.png',
    appRole: 'parent',
    adaptiveIcon: 'apps/parent-mobile/assets/adaptive-icon.png',
    ...
    splashIcon: 'apps/parent-mobile/assets/splash-icon.png',
