...
console.log('- iOS store-test builds are blocked until Apple distribution credentials are set up interactively in EAS.')
console.log('')
...
console.log('- Set up Apple distribution credentials interactively before rerunning iOS store-test builds.')
console.log('')
