...
apps.forEach((app) => {
  ...
  assertIncludes(appSource, 'Sign out', `${app.name} button copy`)
  assertIncludes(appSource, 'Enable notifications', `${app.name} notification copy`)
  assertIncludes(appSource, 'Disable notifications', `${app.name} notification copy`)
  assertIncludes(appSource, 'Biometric unlock', `${app.name} biometric copy`)
