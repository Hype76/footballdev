...
if (existsSync(join(repoRoot, releaseStatusPath))) {
  ...
  assertIncludes(releaseStatus, 'Submit with the root mobile submit commands only after device QA, screenshots, reviewer notes, and store records are complete.', 'Mobile release status')
