...
assertIncludes(mobileNotifications, "const MOBILE_PUSH_CONTEXT_KEY = 'football-player:mobile-push-context'", 'Mobile notification context')
...
assertIncludes(coachAppSource, "latestEvent?.eventType === 'goal' && !['postponed', 'cancelled'].includes(match.status)", 'Coach mobile score correction UI')
