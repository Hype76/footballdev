...
test('Chat home groups controlled room types and explains shared Coach visibility', async () => {
  ...
  assert.match(workspace, /This conversation is visible to you, your player's linked guardians and authorised Coaches for this team\./)
  assert.match(workspace, /Match Squad Chat/)
  assert.match(workspace, /Selected player/)
