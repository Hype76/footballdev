...
test('Coach Calendar resolves and toggles only the selected event Resource links', () => {
  const resources = [
    { id: 'resource-1', links: [{ linkedType: 'calendar_event', linkedId: 'event-1', calendarOccurrenceDate: '2026-08-27' }] },
    { id: 'resource-2', links: [{ linkedType: 'calendar_event', linkedId: 'event-2', calendarOccurrenceDate: '2026-08-27' }] },
    { id: 'resource-3', links: [{ linkedType: 'player', linkedId: 'event-1' }] },
  ]
  assert.deepEqual(getCoachCalendarEventResourceIds(resources, 'event-1', '2026-08-27'), ['resource-1'])
