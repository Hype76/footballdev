...
test('parent Development source provides navigation, child clearing, direct report URLs, and protected PDF access', () => {
  ...
  assert.match(readFileSync(new URL('../netlify/functions/lib/_parent-development-history.js', import.meta.url), 'utf8'), /development_parent_reports/)
  assert.match(readFileSync(new URL('../netlify/functions/lib/_parent-development-history.js', import.meta.url), 'utf8'), /communication_logs/)
