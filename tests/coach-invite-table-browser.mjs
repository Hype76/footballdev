...
import {getMatchDayDisplayName} from './src/lib/matchday-display.js';const getCoachInviteHistory=async()=>({firstEmailSentAt:'2026-09-10T17:46:00Z',emailSends:3,resendRequests:2,recentEmailSends:['2026-09-15T10:00:00Z'],recentResendRequests:[{at:'2026-09-17T07:09:00Z',queued:2,failed:0},{at:'2026-09-15T12:38:00Z',queued:2,failed:0}]});window.availabilityWrites=[];const setCoachInviteAvailabilityOnBehalf=async(u,invite,status)=>{if(window.failAvailability)throw new Error('Synthetic save failed');window.availabilityWrites.push({id:invite.playerId,status});return{changed:true}};
