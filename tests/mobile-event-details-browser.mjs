...
${parentStyles}
const context={id:'team',teamId:'team',teamName:'FP TEST',role:'head_coach',roleRank:90,paymentAccess:{canMutate:true}},user={id:'coach',activeTeamId:'team',roleRank:90};const contexts=[context];
