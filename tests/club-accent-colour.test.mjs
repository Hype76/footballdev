...
test('club display actions, reads, and UI remain club scoped and explicit-save', async () => {
  ...
  assert.match(coreSource, /clubs:club_id \(name, logo_url, contact_email, theme_accent, theme_button_style, plan_key, plan_status\)/)
  assert.match(parentPortalSource, /clubs:club_id \(name, contact_email, theme_accent, theme_button_style, plan_key, plan_status\)/)
