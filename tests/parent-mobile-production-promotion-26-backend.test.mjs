...
const [migration, installationApi, parentPush, matchDayPush, matchDayCopy, developmentApi, notificationInbox] = await Promise.all([
  ...
  readFile(new URL('../netlify/functions/lib/_parent-notification-inbox.js', import.meta.url), 'utf8'),
])
