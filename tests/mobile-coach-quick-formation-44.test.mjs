...
test('Coach source wires Quick Add intents and the pitch-first Formation workspace', async () => {
  ...
  assert.match(formation, /accessibilityLabel="Formation pitch"/)
  assert.match(formation, /Select full squad/)
  assert.match(formation, /Fill empty positions/)
  assert.doesNotMatch(formation, /Use full squad & build team/)
  assert.doesNotMatch(formation, /Step [1-4] of 4/)
  ...
  assert.match(formation, /FormationPlayerArtwork/)
  assert.match(formation, /FormationSubArtwork/)
  assert.match(formation, /FormationPlayerArtwork/)
  assert.match(formation, /formationVisualStyles/)
  ...
  assert.match(formation, /BOARD_TABS/)
  assert.match(formation, /Save to match/)
  assert.match(formation, /Coaches only/)
  assert.doesNotMatch(formation, /Save and publish to Team Resources/)
  assert.doesNotMatch(formationScreen, /Create a standalone Team plan now/)
  assert.doesNotMatch(formationScreen, /selectPreferredCoachFormationMatch/)
  assert.match(formation, /saveCoachMatchFormationBoard/)
