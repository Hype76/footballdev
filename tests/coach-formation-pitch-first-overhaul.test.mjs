...
test('Coach Formation Board is pitch-first with shirt assets and bottom editing sheets', async () => {
  ...
  assert.match(await readFile(new URL('../apps/mobile-core/src/FormationBoardVisuals.js', import.meta.url), 'utf8'), /styles\.pitchArcWindowTop/)
  assert.match(await readFile(new URL('../apps/mobile-core/src/FormationBoardVisuals.js', import.meta.url), 'utf8'), /styles\.pitchPenaltySpotBottom/)
  assert.match(await readFile(new URL('../apps/mobile-core/src/FormationBoardVisuals.js', import.meta.url), 'utf8'), /styles\.pitchCornerRight/)
