...
test('fixture and squad modals use mobile-safe flex scroll layouts', async () => {
  ...
  assert.match(fixtureSection, /shouldPrioritizeFixtureFields = isKeyboardOpen && isFixtureControlFocused/)
  assert.match(fixtureSection, /shouldPrioritizeFixtureFields \? 'scroll-pb-8' : 'scroll-pb-40'/)
