...
test('CSV, TSV, XLSX, and ODS complete the controlled preview path after strict storage persistence with no business write', async () => {
  const existing = {
    club: {
      id: 'club-fptest',
...
test('the forward migration uses the exact non-decorated production allowlist fixture', async () => {
  const migration = await readFile(new URL('../supabase/migrations/20260723072749_data_transfer_storage_mime_allowlist.sql', import.meta.url), 'utf8')
