...
| Parent calendar RPC | Parent visibility | Auth user must match active parent link; event must be parent visible and audience allowed | Strong parent scoping | Not tier-gated | `supabase/migrations/20260613120000_parent_calendar_visibility_controls.sql:95`. |
| Parent match day RPC | Parent match day | Auth user active parent link; visibility/audience/status checks | Strong parent scoping | Not tier-gated | `supabase/migrations/20260613120000_parent_calendar_visibility_controls.sql:157`. |
