...
export async function handler(event) {
  ...
  try {
    ...
    await loadFanInvitingParent(client, invite)
    ...
    await sendEmail({ from: createFromAddress('Football Player'), to: [invite.email], subject: 'Confirm your Football Player account',
      html: `<p>Confirm your email to continue your Fan invitation.</p><p><a href="${escape(data.properties.action_link)}">Confirm email</a></p>` },
