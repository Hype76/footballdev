...
const inputClass = 'min-h-11 w-full rounded-lg border border-[#cfeedd] bg-[#f8fdf9] px-4 py-3 text-sm font-semibold text-[#101828] outline-none transition focus:border-[#20a464] focus:bg-white focus:ring-2 focus:ring-[#d7f8e5]'
const textareaClass = 'w-full rounded-lg border border-[#cfeedd] bg-[#f8fdf9] px-4 py-3 text-sm font-semibold leading-6 text-[#101828] outline-none transition focus:border-[#20a464] focus:bg-white focus:ring-2 focus:ring-[#d7f8e5]'
const panelClass = 'rounded-lg border border-[#cfeedd] bg-[#f8fdf9] px-4 py-3 shadow-sm shadow-[#d7eadf]/60'
...
const secondaryButtonClass = 'inline-flex min-h-11 items-center justify-center rounded-lg border border-[#cfeedd] bg-white px-5 py-3 text-sm font-black text-[#101828] transition hover:border-[#20a464] hover:bg-[#f0fdf6]'
    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      {templates.map((template, templateIndex) => (
        ...
        >
          ...
          >
            <div className="space-y-4 rounded-lg border border-[#cfeedd] bg-white p-5 shadow-sm shadow-[#d7eadf]/70">
              <label className="flex min-h-11 items-center gap-3 rounded-lg border border-[#cfeedd] bg-[#f8fdf9] px-4 py-3 text-sm font-black text-[#101828]">
                <input
                  type="checkbox"
              ...
              <div className="mt-3 flex flex-wrap gap-3">
                {EMAIL_TEMPLATE_SECTIONS.map((section) => {
                  ...
                  return (
                    <label
                      key={section}
                      className="flex min-h-10 items-center gap-2 rounded-lg border border-[#cfeedd] bg-white px-3 py-2 text-sm font-black text-[#101828]"
                    >
                      <input
                        type="checkbox"
            ...
            <div className="flex flex-wrap gap-2">
              {EMAIL_TEMPLATE_FIELDS.map((field) => (
                <button
                  ...
                  className="inline-flex min-h-10 items-center justify-center rounded-lg border border-[#cfeedd] bg-white px-3 py-2 text-xs font-black text-[#101828] transition hover:border-[#20a464] hover:bg-[#f0fdf6]"
                >
                  {`Add {${field.key}}`}
                </button>
              ))}
