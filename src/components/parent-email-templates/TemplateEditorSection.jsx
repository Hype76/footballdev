...
const textareaClass = 'w-full rounded-lg border border-[#bddcca] bg-[#f6fbf8] px-4 py-3 text-sm font-semibold leading-6 text-[#10231a] outline-none transition focus:border-[#20a464] focus:bg-white focus:ring-2 focus:ring-[#d7f8e5]'
const panelClass = 'rounded-lg border border-[#bddcca] bg-[#f6fbf8] px-4 py-3 shadow-sm shadow-[#067a46]/10'
...
const secondaryButtonClass = 'inline-flex min-h-11 items-center justify-center rounded-lg border border-[#bddcca] bg-white px-5 py-3 text-sm font-black text-[#10231a] transition hover:border-[#20a464] hover:bg-[#f0fdf6]'
    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      {templates.map((template, templateIndex) => (
        ...
        >
          ...
          >
            <div className="space-y-4 rounded-lg border border-[#bddcca] bg-white p-5 shadow-sm shadow-[#067a46]/10">
              <label className="flex min-h-11 items-center gap-3 rounded-lg border border-[#bddcca] bg-[#f6fbf8] px-4 py-3 text-sm font-black text-[#10231a]">
                <input
                  type="checkbox"
            ...
            <div className={panelClass}>
              <p className="text-sm font-black text-[#10231a]">Available for sections</p>
              <div className="mt-3 flex flex-wrap gap-3">
                {EMAIL_TEMPLATE_SECTIONS.map((section) => {
                  ...
                  return (
                    <label
                      key={section}
                      className="flex min-h-10 items-center gap-2 rounded-lg border border-[#bddcca] bg-white px-3 py-2 text-sm font-black text-[#10231a]"
                    >
                      <input
                        type="checkbox"
