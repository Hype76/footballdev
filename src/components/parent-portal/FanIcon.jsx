export function FanIcon({ name = 'fans' }) {
  ...
  return <svg aria-hidden="true" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d={paths[name] || paths.fans} />{name === 'fans' ? <circle cx="9" cy="7" r="4" /> : name === 'game_day' ? <circle cx="12" cy="12" r="10" /> : null}</svg>
}
