export function BillingHeroAndStats({ billingStats, isLoading }) {
  return (
    <>
      <section className="rounded-lg border border-[#abefc6] bg-[#ecfdf3] p-6 shadow-sm shadow-[#d7eadf]/70 sm:p-8">
        <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr] xl:items-end">
          ...
          <div className="rounded-lg border border-[#bfe8cd] bg-white p-5 shadow-sm shadow-[#d7eadf]/70">
