...
export function PlayerEvaluationsHistory({
  ...
  return (
    ...
    >
      {isLoading ? (
        <div className="rounded-lg border border-[#d7e5dc] bg-[#f7faf8] px-6 py-10 text-center text-sm font-bold text-[#4b5f55] shadow-sm shadow-[#047857]/10">
          Loading player history...
        </div>
      ) : evaluations.length === 0 ? (
        <div className="rounded-lg border border-[#d7e5dc] bg-[#f7faf8] px-6 py-10 text-center shadow-sm shadow-[#047857]/10">
          <p className="text-sm font-black uppercase tracking-[0.18em] text-[#047857]">Player History</p>
