    ...
    >
      <div className="border-b border-[#d7eadf] bg-[#f8fdf9] px-5 py-5 sm:px-6">
        <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-end">
          ...
          <span className="inline-flex min-h-10 w-fit items-center rounded-lg border border-[#bddcca] bg-white px-4 text-sm font-black text-[#234331] shadow-sm shadow-[#d7eadf]/60">
      ...
      {recentPlayers.length === 0 ? (
        <div className="m-5 rounded-lg border border-dashed border-[#bddcca] bg-[#f8fdf9] px-4 py-8 text-sm font-bold text-[#5f7468] shadow-sm shadow-[#d7eadf]/60 sm:m-6">
        ...
        <div className="grid gap-3 px-5 py-5 sm:grid-cols-2 sm:px-6 xl:grid-cols-4">
          {paginatedRecentPlayers.items.map((player) => (
            <Link
              ...
              className="group rounded-lg border border-[#d7eadf] bg-white p-4 shadow-sm shadow-[#d7eadf]/70 transition hover:-translate-y-0.5 hover:border-[#20a464] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#20a464]"
            >
              ...
              <p className="mt-1 text-sm font-semibold leading-5 text-[#5f7468]">
