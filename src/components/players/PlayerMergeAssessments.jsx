      ...
      <div className="space-y-5">
        <div className="grid gap-3 md:grid-cols-2">
          {evaluations.map((evaluation) => (
            <label
              key={evaluation.id}
              className="flex min-h-11 items-start gap-3 rounded-lg border border-[#cfeedd] bg-[#f8fdf9] px-4 py-3 text-sm font-semibold text-[#101828]"
            >
              <input
                type="checkbox"
              ...
              <span className="min-w-0">
                ...
                <span className="mt-1 block text-xs font-semibold leading-5 text-[#5f7468]">
        ...
        {mergeSelectedEvaluations.length >= 2 ? (
          <div className="space-y-4 rounded-lg border border-[#cfeedd] bg-[#f8fdf9] p-4">
            <label className="block">
              ...
              <select
                ...
                className="min-h-11 w-full rounded-lg border border-[#cfeedd] bg-white px-4 py-3 text-sm font-semibold text-[#101828] outline-none transition focus:border-[#20a464] focus:ring-2 focus:ring-[#d7f8e5]"
              >
            ...
            <div>
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                {mergeDetailFields.map((field) => {
                  ...
                  return (
                    <label key={field.key} className="block rounded-lg border border-[#cfeedd] bg-white p-3">
                      ...
                      <select
                        ...
                        className="min-h-11 w-full rounded-lg border border-[#cfeedd] bg-[#f8fdf9] px-4 py-3 text-sm font-semibold text-[#101828] outline-none transition focus:border-[#20a464] focus:ring-2 focus:ring-[#d7f8e5]"
                      >
                        {mergeSelectedEvaluations.map((evaluation) => (
                          <option key={evaluation.id} value={evaluation.id}>
                      ...
                      <p className="mt-2 whitespace-pre-wrap break-words text-sm font-semibold leading-6 text-[#5f7468]">
            ...
            <div>
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2">
                {mergeFieldLabels.map((label) => (
                  <label key={label} className="block rounded-lg border border-[#cfeedd] bg-white p-3">
            ...
            <div className="flex flex-col gap-3 rounded-lg border border-[#cfeedd] bg-white p-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
          ...
          <div className="rounded-lg border border-dashed border-[#cfeedd] bg-[#f8fdf9] px-4 py-6 text-sm font-semibold text-[#5f7468]">
