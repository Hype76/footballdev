  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-slate-950/70 px-4 py-6">
      <div
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-lg overflow-hidden rounded-lg border border-slate-200 bg-white shadow-2xl shadow-slate-950/25"
      >
        <div className="border-b border-slate-200 bg-[#fff5f5] px-5 py-5 sm:px-6">
        ...
        <div className="px-5 py-5 sm:px-6">
          <div className="rounded-lg border border-slate-200 bg-[#f9fafb] p-4 text-sm font-semibold text-[#667085] shadow-sm shadow-slate-200/60">
          ...
          <label className="mt-4 block">
            ...
            <textarea
              ...
              rows="4"
              className="min-h-28 w-full rounded-lg border border-slate-200 bg-[#f9fafb] px-4 py-3 text-sm font-semibold text-[#101828] outline-none transition placeholder:text-slate-400 focus:border-red-500 focus:bg-white focus:ring-2 focus:ring-red-100"
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-end">
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-lg border border-slate-200 bg-white px-5 py-3 text-sm font-black text-[#101828] transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
            >
              Cancel
            </button>
            <button
