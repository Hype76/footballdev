  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-[#06140d]/70 px-4 py-6">
      <div
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-lg overflow-hidden rounded-lg border border-[#cfeedd] bg-white shadow-2xl shadow-[#06140d]/25"
      >
        <div className="border-b border-[#cfeedd] bg-[#fff5f5] px-5 py-5 sm:px-6">
        ...
        <div className="px-5 py-5 sm:px-6">
          <div className="rounded-lg border border-[#cfeedd] bg-[#f8fdf9] p-4 text-sm font-semibold text-[#5f7468] shadow-sm shadow-[#d7eadf]/60">
          ...
          <label className="mt-4 block">
            ...
            <textarea
              ...
              rows="4"
              className="min-h-28 w-full rounded-lg border border-[#cfeedd] bg-[#f8fdf9] px-4 py-3 text-sm font-semibold text-[#101828] outline-none transition placeholder:text-[#8da59a] focus:border-red-500 focus:bg-white focus:ring-2 focus:ring-red-100"
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-end">
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center rounded-lg border border-[#cfeedd] bg-white px-5 py-3 text-sm font-black text-[#101828] transition hover:bg-[#e8f7ee] disabled:cursor-not-allowed disabled:opacity-60"
            >
              Cancel
            </button>
            <button
