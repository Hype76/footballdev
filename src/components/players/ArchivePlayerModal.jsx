  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/70 px-4 py-6">
      ...
      >
        ...
        <h2 className="mt-3 pr-12 text-2xl font-semibold tracking-tight text-[var(--text-primary)]">
        ...
        <div className="mt-4 rounded-lg border border-[var(--border-color)] bg-[var(--panel-alt)] p-4 text-sm text-[var(--text-muted)]">
        ...
        <label className="mt-4 block">
          ...
          <textarea
            ...
            rows="4"
            className="min-h-28 w-full rounded-lg border border-[var(--border-color)] bg-[var(--panel-alt)] px-4 py-3 text-sm text-[var(--text-primary)] outline-none transition focus:border-[var(--accent)]"
