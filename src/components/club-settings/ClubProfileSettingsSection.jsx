        ...
        <div className="grid gap-5 xl:grid-cols-[0.72fr_1fr]">
          <div className="rounded-md border border-slate-200 bg-slate-50 p-5">
            ...
            {canChangeClubLogo ? (
              <div className="mt-5 space-y-4">
                <label className="block">
                  ...
                  <input
                    ...
                    className="block min-h-11 w-full rounded-md border border-slate-200 bg-white px-4 py-3 text-sm text-slate-950 file:mr-4 file:rounded-md file:border-0 file:bg-slate-950 file:px-3 file:py-2 file:text-sm file:font-bold file:text-white"
                  />
              ...
              <div className="mt-5 rounded-md border border-slate-200 bg-white px-4 py-3 text-sm leading-6 text-slate-600">
