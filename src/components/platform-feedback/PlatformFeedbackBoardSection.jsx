                ...
                <button
                  ...
                  className={[
                    ...
                    item.hasVoted
                      ...
                      : 'border border-[#bddcca] bg-white text-[#10231a] shadow-sm shadow-[#067a46]/10 hover:border-[#20a464] hover:bg-[#f0fdf6]',
                  ].join(' ')}
                >
                ...
                <div className="mt-4 rounded-lg border border-[#bddcca] bg-white p-4">
                  ...
                  <div className="mt-3 space-y-3">
                    {item.comments.map((comment) => (
                      <div key={comment.id} className="rounded-lg border border-[#bddcca] bg-[#f6fbf8] px-4 py-3">
