        ...
        <div className="px-5 py-6 sm:px-6 sm:py-8">
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            {['One idea per item', 'Votes show demand', 'Admin replies stay visible'].map((rule) => (
              <div key={rule} className="rounded-lg border border-[#cbd5e1] bg-[#f8fafc] px-4 py-4 shadow-sm shadow-[#2563eb]/10">
                <p className="text-sm font-black text-[#0f172a]">{rule}</p>
              </div>
            ))}
          </div>
        </div>
        <div className="grid content-between border-t border-[#cbd5e1] bg-[#eff6ff] px-5 py-6 sm:px-6 xl:border-l xl:border-t-0">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#2563eb]">Board state</p>
          ...
          <div className="mt-5 rounded-lg border border-[#cbd5e1] bg-white px-4 py-4 shadow-sm shadow-[#2563eb]/10">
            <p className="text-sm font-black text-[#0f172a]">Best feedback format</p>
