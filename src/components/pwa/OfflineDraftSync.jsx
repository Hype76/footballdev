...
export default function OfflineDraftSync() {
  ...
  return (
    <div className="fixed bottom-4 left-4 z-50 max-w-sm rounded-lg border border-[#cbd5e1] bg-white px-4 py-3 text-sm font-black text-[#0f172a] shadow-lg shadow-[#2563eb]/10">
