...
export function ToastProvider({ children }) {
  ...
  return (
    <ToastContext.Provider value={value}>
      {children}
      <div className="fixed bottom-[var(--mobile-floating-bottom-clearance)] right-4 z-[200] flex w-[calc(100vw-2rem)] max-w-sm flex-col gap-3 transition-[bottom] duration-150 motion-reduce:transition-none">
        {toasts.map((toast) => (
