  ...
  return (
    <section className="order-2 lg:order-1">
      <div className="grid max-w-6xl gap-6 lg:grid-cols-[1fr_23rem] lg:items-end">
        <div>
          <div className="inline-flex rounded-lg border border-[#bddcca] bg-white/90 px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[#067a46] shadow-sm shadow-[#067a46]/10 backdrop-blur">
            Football club operations
          </div>
          <h1 className="mt-5 max-w-4xl text-4xl font-black leading-[1.02] tracking-tight text-[#10231a] min-[420px]:text-5xl sm:text-6xl xl:text-7xl">
            The football week, rebuilt around real club work.
          </h1>
          <p className="mt-5 max-w-3xl text-base font-semibold leading-7 text-[#345343] sm:text-lg sm:leading-8">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a
              href="/sign-in"
              className="inline-flex min-h-12 items-center justify-center rounded-lg bg-[#067a46] px-5 py-3 text-sm font-black text-white shadow-sm shadow-[#067a46]/20 transition hover:bg-[#05603a]"
            >
              Open workspace
            </a>
            <a
              href="/features"
              className="inline-flex min-h-12 items-center justify-center rounded-lg border border-[#bddcca] bg-white/95 px-5 py-3 text-sm font-black text-[#10231a] shadow-sm shadow-[#067a46]/10 transition hover:bg-[#f0fdf6]"
            >
              Explore features
            </a>
          </div>
        ...
        <aside className="rounded-lg border border-[#bddcca] bg-white/94 p-4 shadow-lg shadow-[#10231a]/10 backdrop-blur sm:p-5">
      ...
      <div className="mt-7 grid max-w-6xl gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="rounded-lg border border-[#bddcca] bg-[#f0fdf6]/95 p-5 shadow-sm shadow-[#067a46]/10 backdrop-blur sm:p-6">
          ...
          <div className="mt-5 grid gap-3">
            {setupSteps.map(([number, title, copy]) => (
              <article key={title} className="grid grid-cols-[2.5rem_1fr] gap-3 rounded-lg border border-[#bddcca] bg-white p-4">
        ...
        <section className="rounded-lg border border-[#bddcca] bg-white/95 p-5 shadow-sm shadow-[#067a46]/10 backdrop-blur sm:p-6">
