...
const panelClass = 'rounded-lg border border-[#d7e5dc] bg-white p-5 shadow-sm shadow-[#047857]/10 sm:p-6'
...
export function LoginMarketingAndPricing({
  ...
  return (
    <section className="space-y-5 pb-8 text-[#101828]">
      <div className={panelClass}>
        ...
        <div className="mt-3 grid gap-5 lg:grid-cols-[1fr_0.8fr] lg:items-end">
          <div>
            ...
            <p className="mt-4 max-w-4xl text-base font-semibold leading-8 text-[#4b5f55]">
        ...
        <div className={panelClass}>
          ...
          <div className="mt-6 grid gap-3">
            {operatingSystemRows.map(([title, copy], index) => (
              <article key={title} className="grid gap-3 rounded-lg border border-[#d7e5dc] bg-[#f7faf8] p-4 sm:grid-cols-[2.5rem_1fr]">
                <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#047857] text-sm font-black text-white">
                  {index + 1}
                </span>
                <span>
        ...
        <div className="grid gap-5 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {onboardingRules.map((rule) => (
              <div key={rule} className="rounded-lg border border-[#bbf7d0] bg-[#ecfdf5] p-4 text-sm font-black leading-6 text-[#065f46]">
                {rule}
              </div>
            ))}
          </div>
      ...
      <div className="flex flex-col gap-4 rounded-lg border border-[#d7e5dc] bg-white p-5 shadow-sm shadow-[#047857]/10 sm:p-6 lg:flex-row lg:items-end lg:justify-between">
        <div>
      ...
      {paymentsDisabled ? (
        <div className="rounded-lg border border-[#bbf7d0] bg-[#ecfdf5] px-5 py-4 text-sm font-black text-[#065f46]">
      ...
      <footer className="flex flex-col gap-3 border-t border-[#d7e5dc] pt-6 text-sm font-semibold text-[#4b5f55] sm:flex-row sm:items-center sm:justify-between">
