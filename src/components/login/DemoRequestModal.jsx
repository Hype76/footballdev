  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-[#10231a]/45 px-4 py-6 backdrop-blur-sm">
      <div
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-xl overflow-hidden rounded-lg border border-[#bfe8cd] bg-white text-[#101828] shadow-xl shadow-[#10231a]/15"
      >
        <button
          type="button"
          onClick={onCancel}
          ...
          className="absolute right-4 top-4 inline-flex h-10 w-10 items-center justify-center rounded-lg border border-[#bfe8cd] bg-white text-sm font-black text-[#456653] shadow-sm transition hover:bg-[#f0fdf6] disabled:cursor-not-allowed disabled:opacity-60"
        >
          X
        </button>
        <div className="border-b border-[#d7f8e5] bg-[#f8fdf9] px-5 py-5 sm:px-6">
        ...
        <form className="grid gap-4 px-5 py-5 sm:px-6" onSubmit={onSubmit}>
          ...
          <div className="rounded-lg border border-[#b7efce] bg-[#f0fdf6] px-4 py-3">
          ...
          <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:justify-end">
            <button
              ...
              onClick={onCancel}
              className="inline-flex min-h-12 items-center justify-center rounded-lg border border-[#bfe8cd] bg-white px-5 py-3 text-sm font-black text-[#101828] transition hover:bg-[#f0fdf6] disabled:cursor-not-allowed disabled:opacity-60"
            >
              Cancel
            </button>
            <button
