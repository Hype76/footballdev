...
export const PUBLIC_FREE_SIGNUP_PLAN_KEY = PLAN_KEYS.matchday
...
export function getPublicFreeSignupPlanKey(value) {
  ...
  return [PUBLIC_FREE_SIGNUP_PLAN_KEY, PLAN_KEYS.individual].includes(planKey) ? PUBLIC_FREE_SIGNUP_PLAN_KEY : ''
}
