...
import { normalizeThemeAccent, normalizeThemeButtonStyle } from '../theme.js'
...
export function normalizeClubSettingsRow(row) {
  return {
    ...
    themeButtonStyle: normalizeThemeButtonStyle(row.theme_button_style ?? row.themeButtonStyle),
