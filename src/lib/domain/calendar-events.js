...
export async function notifyCalendarEventParents({
  ...
  return {
    ...
    actionReconciliationState: normalizeText(data?.actionReconciliationState),
    authoritativePlayerCount: Number(data?.authoritativePlayerCount ?? 0),
    actionablePlayerCount: Number(data?.actionablePlayerCount ?? 0),
    missingPlayerLinkCount: Number(data?.missingPlayerLinkCount ?? 0),
    playerRequestCreatedCount: Number(data?.playerRequestCreatedCount ?? 0),
    playerRequestPreservedCount: Number(data?.playerRequestPreservedCount ?? 0),
    playerRequestClosedCount: Number(data?.playerRequestClosedCount ?? 0),
    volunteerConfiguredRoleCount: Number(data?.volunteerConfiguredRoleCount ?? 0),
    volunteerOpenRoleCount: Number(data?.volunteerOpenRoleCount ?? 0),
    volunteerRequestCreatedCount: Number(data?.volunteerRequestCreatedCount ?? 0),
    volunteerRequestPreservedCount: Number(data?.volunteerRequestPreservedCount ?? 0),
    volunteerRequestClosedCount: Number(data?.volunteerRequestClosedCount ?? 0),
    acceptedVolunteerAssignmentCount: Number(data?.acceptedVolunteerAssignmentCount ?? 0),
