...
export const CAPABILITY_REGISTRY = Object.freeze({
  ...
  [CAPABILITIES.teamStaffRoles]: capability({ key: CAPABILITIES.teamStaffRoles, label: 'Team Coach roles', category: 'Single Team', minimumPlanKey: ACCESS_PLAN_KEYS.singleTeam, includedPlans: SINGLE_TEAM_AND_ABOVE, requiresPayment: true, action: 'use team Coach roles' }),
  ...
  [CAPABILITIES.clubStaffRoles]: capability({ key: CAPABILITIES.clubStaffRoles, label: 'Club Coach roles', category: 'Small Club', minimumPlanKey: ACCESS_PLAN_KEYS.smallClub, includedPlans: SMALL_CLUB_AND_ABOVE, requiresPayment: true, action: 'manage club Coach roles', rolePolicy: { minimumRoleRank: 50 } }),
