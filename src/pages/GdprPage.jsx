...
export function GdprPage() {
  ...
  const itemClass = 'rounded-lg border border-slate-200 bg-slate-50 p-4'
        ...
        <div className="grid gap-5">
          ...
          <section className={sectionClass}>
            ...
            <ul className="mt-4 grid gap-3">
              {rights.map((right) => (
                <li key={right} className="rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm leading-6 text-slate-700">
                  {right}
                </li>
              ))}
            </ul>
