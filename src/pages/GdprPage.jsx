...
const itemClass = 'rounded-lg border border-[#bddcca] bg-[#f6fbf8] p-4'
        ...
        <div className="grid gap-5">
            ...
            <div className="mt-5 grid gap-3 md:grid-cols-2">
              {dataTypes.map(([title, copy]) => (
                <div key={title} className={itemClass}>
                  <p className="font-black text-[#10231a]">{title}</p>
                  <p className="mt-2 text-sm font-semibold leading-6 text-[#456653]">{copy}</p>
                </div>
              ))}
            </div>
          ...
          <section className={sectionClass}>
            ...
            <ul className="mt-4 grid gap-3">
              {rights.map((right) => (
                <li key={right} className="rounded-lg border border-[#bddcca] bg-[#f6fbf8] px-4 py-3 text-sm font-semibold leading-6 text-[#456653]">
                  {right}
                </li>
              ))}
            </ul>
