      ...
      <section className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm shadow-slate-200/80">
        <div className="grid gap-6 px-5 py-6 sm:px-6 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-stretch">
          ...
          <div className="grid content-between rounded-lg border border-slate-200 bg-[#f9fafb] p-5 shadow-sm shadow-slate-200/70">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.18em] text-[#667085]">Setup state</p>
              <p className="mt-2 text-2xl font-black tracking-tight text-[#101828]">{identityChecksComplete} of 3 identity checks ready</p>
            ...
            <div className="mt-5 rounded-lg border border-slate-200 bg-white p-4">
              <div className="flex items-center gap-3">
                <span className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-slate-200 bg-[#101828]">
                  <img src={resolvedLogoUrl} alt="" className="h-full w-full object-contain p-1" />
                </span>
                <div className="min-w-0">
                  <p className="truncate text-base font-black text-[#101828]">{formData.name || user?.clubName || 'Club name not set'}</p>
