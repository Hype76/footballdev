...
export function ResetPasswordPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f6fbf8] px-4 py-8 text-[#10231a] sm:px-6">
      <section className="w-full max-w-xl rounded-lg border border-[#bddcca] bg-white px-6 py-8 shadow-sm shadow-[#067a46]/10 sm:px-10 sm:py-10">
        <div className="flex items-center gap-4">
          <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-lg border border-[#bddcca] bg-[#10231a]">
          ...
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black tracking-tight text-[#10231a]">Reset password</h1>
          </div>
        </div>

        <p className="mt-6 text-sm font-semibold leading-6 text-[#456653]">
          Enter a new password for your account. After the update you will be signed out and can log in again.
        </p>
        <div className="mt-5 rounded-lg border border-[#bddcca] bg-[#f0fdf6] px-4 py-3 text-sm font-semibold leading-6 text-[#456653]">
          Use a password that belongs only to this account. Shared staff or parent passwords should not be used.
        </div>

        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          <label className="block">
            <span className="mb-2 block text-sm font-bold text-[#10231a]">New password</span>
            <input
          ...
          <label className="block">
            <span className="mb-2 block text-sm font-bold text-[#10231a]">Confirm password</span>
            <input
              type={isPasswordVisible ? 'text' : 'password'}
          ...
          <label className="inline-flex min-h-11 items-center gap-3 rounded-lg border border-[#bddcca] bg-white px-4 py-3 text-sm font-bold text-[#10231a]">
            <input
              type="checkbox"
          ...
          {message ? (
            <div className="rounded-lg border border-[#bddcca] bg-[#f0fdf6] px-4 py-3 text-sm font-medium text-[#05603a]">
              {message}
            </div>
          ) : null}
