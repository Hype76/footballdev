  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] pb-[max(5.5rem,env(safe-area-inset-bottom))] text-[#0f172a] lg:pb-0">
      ...
      <section className="mx-auto grid w-full max-w-6xl gap-6 px-4 py-8 pb-[max(2.5rem,env(safe-area-inset-bottom))] sm:px-6 sm:py-12 lg:grid-cols-[0.75fr_1fr] lg:gap-8 lg:px-8 lg:py-16">
        <div className="order-2 flex items-start justify-center overflow-hidden rounded-lg border border-[#cbd5e1] bg-white p-4 shadow-sm shadow-[#2563eb]/10 sm:p-6 lg:order-1">
          <img
        ...
        <div className="order-1 flex flex-col justify-center lg:order-2">
          <p className="text-xs font-black uppercase tracking-[0.18em] text-[#2563eb]">Parent portal</p>
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-3">
            {[
              ...
              <article key={title} className="rounded-lg border border-[#cbd5e1] bg-white p-4 shadow-sm shadow-[#2563eb]/10">
