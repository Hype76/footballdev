...
export function NotFoundPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f6fbf8] px-4 py-10 text-[#10231a]">
      <div className="w-full max-w-xl rounded-lg border border-[#bddcca] bg-white p-8 text-center shadow-xl shadow-[#067a46]/10">
        <p className="text-sm font-black uppercase tracking-[0.24em] text-[#067a46]">404</p>
        <h1 className="mt-4 text-4xl font-black tracking-tight text-[#10231a]">Page not found</h1>
