...
const statCardClass = 'rounded-lg border border-[#cbd5e1] bg-white px-4 py-4 shadow-sm shadow-[#2563eb]/10'
        ...
        <div className="grid gap-6 px-5 py-6 sm:px-6 lg:grid-cols-[minmax(0,1fr)_24rem] lg:items-stretch">
          ...
          <div className="grid content-between rounded-lg border border-[#cbd5e1] bg-[#f8fafc] p-5 shadow-inner shadow-[#2563eb]/10">
            <div>
              ...
              <p className="mt-2 text-2xl font-black tracking-tight text-[#0f172a]">{enabledTemplateCount} enabled for {audienceLabel} emails</p>
